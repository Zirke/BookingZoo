...
public class PostToCalendarTest {
    ...
    public void testBirthday() throws IOException, GeneralSecurityException {
        //ArrangementBooking testBirthdayBooking = new ArrangementBooking(BookingStatus.STATUS_ACTIVE, 15, new FoodOrder(ChoiceOfMenu.MENU_FOUR), "Thomas", 11, "Jonas", "Karsten", "29125645", "Kasrten@Email.com");
